...
// Scene 1 (25.2s): Opening — "You are already helping your child learn."
    ...
    >
      ...
      >
        <img
          ...
          alt="African mother talking with her child"
        />
      ...
      <motion.div
        ...
        style={{ background: 'radial-gradient(ellipse at 30% 65%, #E8820C, transparent 60%)' }}
      />
      ...
      <div className="absolute bottom-0 left-0 right-0 z-10 p-12 pb-16">
        ...
        >
          ...
          >
            Five Things You{' '}
            <span className="text-[#E8820C]">Already Do</span>
          </h1>
          <h2
            className="text-[3.8vw] font-bold text-[#F5EDD6]/80 leading-tight mt-1"
            style={{ fontFamily: 'var(--font-display)' }}
          >
            That Help Your Child Learn
          </h2>
        </motion.div>
        ...
        <motion.p
          className="text-[2.0vw] text-[#F5EDD6]/80 mt-5 max-w-[55%] leading-relaxed"
          style={{ fontFamily: 'var(--font-body)' }}
          initial={{ opacity: 0, y: 12 }}
          animate={phase >= 3 ? { opacity: 1, y: 0 } : { opacity: 0, y: 12 }}
          transition={{ duration: 1.0 }}
        >
          The most powerful learning tool your child has is not at school.
          It is at home. It is <span className="text-[#E8820C] font-semibold">you</span>.
        </motion.p>
      </div>
    </motion.div>
  );
