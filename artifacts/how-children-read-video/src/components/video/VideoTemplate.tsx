...
const SCENE_COMPONENTS: Record<string, React.ComponentType> = {
  s1_opening: Scene1,
  s2_pre_reader: Scene2,
  s3_feed_monster: Scene3,
  s4_early_reader: Scene4,
  s5_curious_reader: Scene5,
  s6_emerging_reader: Scene6,
  s7_close: Scene7,
};
    ...
    <div className="relative w-full h-screen overflow-hidden bg-[var(--color-bg-dark)] text-[var(--color-text-primary)]">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <motion.div
          ...
          animate={{
            left: ['8%', '20%', '50%', '25%', '12%', '45%', '35%'][sceneIndex] ?? '8%',
            width: ['30%', '55%', '20%', '50%', '40%', '25%', '60%'][sceneIndex] ?? '30%',
            top: ['25%', '70%', '40%', '15%', '80%', '55%', '45%'][sceneIndex] ?? '25%',
            opacity: 0.4,
          }}
